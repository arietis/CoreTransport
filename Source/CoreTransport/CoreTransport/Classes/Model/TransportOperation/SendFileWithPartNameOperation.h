//
//  SendFileWithPartNameOperation.h
//  CoreTransport
//
...
/**
 Операция для транспортного метода -sendFile:asBodyPart:fileName:fileType:withParameters:atEndpoint:.
 */
@interface SendFileWithPartNameOperation : ParameterizedOperation
...
/**
 Название параметра для отправляемого файла.
 */
@property (nonatomic, strong, readonly) NSString *partName;
